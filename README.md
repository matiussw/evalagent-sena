...
Esta rama corresponde a la **Entrega 2 — código funcional**: el diseño descrito en las
secciones 2 a 4 está implementado y ejecutable.

| Elemento | Estado |
|---|---|
| Documentación (producto, arquitectura, modelo de datos, historias, tickets) | ✅ Completa |
| Backend: dominio, autenticación multi-tenant, 28 endpoints REST + canal WebSocket | ✅ Funcional |
| Frontend React: login, panel docente, sala de sustentación y pantalla de revisión | ✅ Funcional |
| Tests | ✅ 119 backend (73 % cobertura) · 4 frontend |
| CI en GitHub Actions | ✅ Configurado |
| Despliegue público y test E2E de navegador | ⏳ Entrega final |

> El prototipo v1 (monousuario, sin autenticación, persistencia en ficheros) está
> documentado en [`DOCUMENTACION_TECNICA.md`](DOCUMENTACION_TECNICA.md) como referencia
> histórica; su interfaz se conserva en `frontend/legacy/`. Las discrepancias entre su
> documentación y su código motivaron varios de los tickets de la sección 6 — entre ellos
> el T-012, que dejaba el sistema mudo fuera de macOS.
